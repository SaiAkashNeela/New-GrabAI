...
const translations = {
  en: {
    ...
    // Footer
    "footer.powered_by": "Powered by GrabAI",
  ...
  es: {
    ...
    // Footer
    "footer.powered_by": "Desarrollado por GrabAI",
  ...
  fr: {
    ...
    // Footer
    "footer.powered_by": "Propulsé par GrabAI",
  ...
  de: {
    ...
    // Footer
    "footer.powered_by": "Betrieben von GrabAI",
  ...
  ja: {
    ...
    // Footer
    "footer.powered_by": "GrabAIによって提供",
