      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden md:flex flex-col sm:flex-row justify-between items-center gap-8">
          <div className="flex items-center space-x-4">
            <img src="/images/grabai-logo.png" alt="GrabAI" className="h-14" />
            <FooterPopup />
          </div>

          <div className="flex flex-col sm:flex-row items-center gap-8">
            <div className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} GrabAI. All rights reserved.
            </div>
        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="text-center space-y-4">
            <img src="/images/grabai-logo.png" alt="GrabAI" className="h-12 mx-auto" />
            <div className="text-muted-foreground text-xs">
              &copy; {new Date().getFullYear()} GrabAI. All rights reserved.
            </div>
          </div>
